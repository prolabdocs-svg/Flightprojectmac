...
export const FRAME_ZERO: FrameDefinition = {
  id: 'frame_zero',
  name: 'Frame Zero',
  description: 'El tubo y tela del taller. Lento y frágil, pero es tuyo y vuela con lo que hay en el banco.',
  tier: 0,
  hardpoints: [
...
export const FRAME_BUSH_KING: FrameDefinition = {
  ...
  requiresTechId: 'airframe_bush_king',
  hardpoints: [
    { id: 'engineMountRear', category: 'engine', accepts: ['engine_medium', 'engine_efficient'] },
...
export const FRAMES: FrameDefinition[] = [FRAME_ZERO, FRAME_YARDBIRD, FRAME_TRAILBLAZER, FRAME_BUSH_KING];
